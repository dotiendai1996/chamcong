...
{
    public class GetQuanLyNghiPhepForEditOutput
    {
		public CreateOrEditQuanLyNghiPhepDto QuanLyNghiPhep { get; set; }
        ...
        public List<QuanLyTrucTiepPNPDto> QuanLyTrucTiepList { get; set; }
